...
public class Utilidades {
    ...
    public static double hipotenusa(double cateto1, double c2) {
        return Math.sqrt(alCuadrado(cateto1) + alCuadrado(c2));
    }

    public static double catetoA(double hipotenusa, double c) {
        return Math.sqrt(alCuadrado(hipotenusa) - alCuadrado(c));
    }
